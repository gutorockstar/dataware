...
namespace DoctrineORMModule\Proxy\__CG__\Manager\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Category extends \Manager\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'categoryfather', 'cover', 'description', 'active');
        }
    ...
    public function setCategoryfather($categoryfather)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCategoryfather', array($categoryfather));
